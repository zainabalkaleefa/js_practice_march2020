...
describe("findWinner", () => {
  ...
  describe("getScreentimeAlertList", () => {
    ...
    test("Check if the date is not available", () => {
        expect(() => {getScreentimeAlertList(
            [
                {
                username: "beth_1234",
            ...
            ], "2019-06-10");}).toThrow("date is not available");
    });


    test("Check if the no user exceed 100m in the giving date", () => {
        expect(() => {getScreentimeAlertList(
            [
                {
                username: "beth_1234",
            ...
            ], "2019-06-11");}).toThrow("No user exceed 100m in that date");
    });
